...
#define BLE_nSUSPEND		IOPORT_CREATE_PIN(PORTF, 4)
#define BLE_SLEEP			IOPORT_CREATE_PIN(PORTF, 5)
#define BLE_RTS				IOPORT_CREATE_PIN(PORTF, 6)
#define BLE_nRESET			IOPORT_CREATE_PIN(PORTF, 7)
